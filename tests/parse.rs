...
pub fn test_parse_standard() {
    ...
    assert_eq!(bitboards.white_royal, 1 << 4);
    assert_eq!(bitboards.black_royal, 1 << (7 * 8 + 4));
    ...
    assert_eq!(bitboards.white[2], 1 << 4);
    assert_eq!(bitboards.black[2], 1 << (7 * 8 + 4));
    assert_eq!(bitboards.white[3], 1 << 4);
    assert_eq!(bitboards.black[3], 1 << (7 * 8 + 4));
    assert_eq!(bitboards.white[4], 1 << 4);
    assert_eq!(bitboards.black[4], 1 << (7 * 8 + 4));
    assert_eq!(bitboards.white[5], 1 << 4);
    assert_eq!(bitboards.black[5], 1 << (7 * 8 + 4));
    assert_eq!(bitboards.white[6], 1 | (1 << 3) | (1 << 7));
    assert_eq!(bitboards.black[6], (1 | (1 << 3) | (1 << 7)) << (7 * 8));
    assert_eq!(bitboards.white[7], (1 << 2) | (1 << 3) | (1 << 5));
    assert_eq!(bitboards.black[7], ((1 << 2) | (1 << 3) | (1 << 5)) << (7 * 8));
    assert_eq!(bitboards.white[8], 1 << 3);
    assert_eq!(bitboards.black[8], 1 << (7 * 8 + 3));
    assert_eq!(bitboards.white[9], 1 << 3);
    assert_eq!(bitboards.black[9], 1 << (7 * 8 + 3));
    assert_eq!(bitboards.white[10], (1 << 1) | (1 << 6));
    assert_eq!(bitboards.black[10], ((1 << 1) | (1 << 6)) << (7 * 8));
}
