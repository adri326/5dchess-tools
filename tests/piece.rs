...
pub fn test_properties(kind: PieceKind, (royal, castle, castle_to, promote, enpassant, kickstart): (bool, bool, bool, bool, bool, bool)) {
...
pub fn test_piece_properties() {
    ...
    test_properties(PieceKind::Knight, (false, false, false, false, false, false));
    test_properties(PieceKind::Bishop, (false, false, false, false, false, false));
    ...
    test_properties(PieceKind::Princess, (false, false, false, false, false, false));
    test_properties(PieceKind::King, (true, true, false, false, false, false));
    test_properties(PieceKind::Unicorn, (false, false, false, false, false, false));
    test_properties(PieceKind::Dragon, (false, false, false, false, false, false));
    test_properties(PieceKind::CommonKing, (false, false, false, false, false, false));
    test_properties(PieceKind::RoyalQueen, (true, false, false, false, false, false));
}
