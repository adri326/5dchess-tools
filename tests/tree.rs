...
fn test_dfs_rook_tactics_1() {
    ...
    assert_eq!(res, dfs_schedule(&game, 1, Some(Duration::new(10, 0)), NoEvalFn::new(), 128, 10000, N_THREADS, |_| true), "dfs_schedule to return the same value as dfs");
...
fn test_dfs_rook_tactics_2() {
    ...
    let dfs_res = dfs_schedule(&game, 3, Some(Duration::new(30, 0)), NoEvalFn::new(), 128, 10000, N_THREADS, |_| true).expect("dfs_schedule should return Some(...)");
