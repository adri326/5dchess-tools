...
/**
    ...
    - to verify that a move/moveset is legal by passing it the newly generated `PartialGame`
    - to verify that a position is in check by passing it the IDLE boards, generated by `generate_idle_boards`
